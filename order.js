(function () {
  ...
  function sendOrderEmail(orderRecord, lines, notes) {
    var OWNER_EMAIL = "Kabusweck311@gmail.com";
    var web3Key = (window.EMAIL_CONFIG && window.EMAIL_CONFIG.web3formsAccessKey) || "";
  ...
  function requestEmailActivation() {
    ...
    fetch("https://formsubmit.co/ajax/" + encodeURIComponent("Kabusweck311@gmail.com"), {
      method: "POST",
      headers: { Accept: "application/json" },
      body: formData,
    })
      ...
      .then(function (data) {
        var msg = (data && data.message) || "Check Kabusweck311@gmail.com (and Spam).";
        showToast(msg);
        window.alert(
          msg +
            "\n\nOpen Kabusweck311@gmail.com → Inbox/Spam → FormSubmit → click Activate Form."
        );
      })
      .catch(function () {
  ...
  var activateBtn = document.getElementById("email-activate-btn");
  if (activateBtn) activateBtn.addEventListener("click", requestEmailActivation);
